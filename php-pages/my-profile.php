            ...
            <div class='profpost'>
                <div class="postphoto">
                    ...
                    <form action="control.php" method="POST" enctype='multipart/form-data'>
                        ...
                        <button type="submit" name="addsubmit"><i class="far fa-paper-plane" aria-hidden="true"></i>
                        </button>
                    </form>
                </div>
                <div class="postvideo">
                    ...
                    <form action="control.php" method="POST" enctype='multipart/form-data'>
                        ...
                        <input type="hidden" name="user" value="<?php echo $_SESSION['username'];?>">
                        <button type="submit" name="addvideosubmit"><i class="far fa-paper-plane" aria-hidden="true"></i>
                        </button>
                    </form>
                </div>
            </div>
