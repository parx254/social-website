    ...
    if ($result->num_rows > 0) {
      while ($row = $result->fetch_assoc()) {
        ...
        if (!$result) {
          ...
          echo '</div><p><i class="far fa-calendar" aria-hidden="true"></i> ' . $date_posted . '<br>';
    ...
    if ($result->num_rows > 0) {
      while ($row = $result->fetch_assoc()) {
        ...
        if (!$result) {
          ...
          echo '</div><p><i class="far fa-calendar-o" aria-hidden="true"></i> ' . $date_posted . '<br>';
          echo '<i class="far fa-map-marker-alt" aria-hidden="true"></i>
          ' . $row['videolocation'] . '<br>';
          echo '<i class="far fa-tag" aria-hidden="true"></i>' . $row['videocategory'] . '<br><br>';
          echo '' . $row['Blog'] . '<br><br>';
          echo '<i class="far fa-heart-o"></i> ' . $row['likes'];
          //echo $postID;
          echo "<input id = 'postID$postID' type = 'hidden' name = 'postID' value = '" . $postID . "'></form>";
          echo "<input id = 'formID' type = 'hidden' name = 'formID' value = '#form$postID'></form>";
      ...
      if (empty($row['Bio']) && empty($row['Birthday']) && empty($row['HomeCity'])) {
        ...
        echo "
              ...
              <form method='post' action='control' enctype='multipart/form-data'>
                  ...
                  <br>
                  <br>
              <button type='submit' name='profilePic'><i class='far fa-paper-plane' aria-hidden='true'></i></button></form>
              <br>
              <form method='post' action='control' enctype='multipart/form-data'>
                  Change Cover Photo
                  <input type='file' name='Filename' required>
                  <br>
                  <br>
              <button type='submit' name='coverPic'><i class='far fa-paper-plane' aria-hidden='true'></i></button></form>
              ";
      }
    } else {
  ...
  function myfeed()
  {
    ...
    if ($result->num_rows > 0) {
      while ($row = $result->fetch_assoc()) {
        ...
        echo '<br><p><i class="far fa-calendar" aria-hidden="true"></i> ' . $date_posted . '<br>';
        echo '<p><i class="far fa-map-marker-alt" aria-hidden="true"></i> ' . $row['Location'] . '<br>';
        echo '<i class="far fa-tag" aria-hidden="true"></i> ' . $row['category'] . '<br><br>';
        echo ' ' . $row['Blog'] . '<br><br>';
        echo '<i class="far fa-heart"></i> ' . $row['likes'];
  ...
  function myvideofeed()
  {
    ...
    if ($result->num_rows > 0) {
      while ($row = $result->fetch_assoc()) {
        ...
        echo "<b><a href='profile.php?currentuser=$username'>   " . $username . '</a></b></div>';
        echo '<p><i class="far fa-calendar" aria-hidden="true"></i> ' . $date_posted . '<br>';
        echo '<p><i class="far fa-map-marker-alt" aria-hidden="true"></i> ' . $row['Location'] . '<br>';
        echo '<i class="far fa-tag" aria-hidden="true"></i> ' . $row['videocategory'] . '<br><br>';
        echo ' ' . $row['Blog'] . '<br><br>';
        echo '<i class="far fa-heart"></i> ' . $row['likes'] . ' </div></div>';
      }
    }
  }
    ...
    if ($result->num_rows > 0) {
      while ($row = $result->fetch_assoc()) {
        ...
        if (!$result) {
          ...
          echo '<i class="far fa-map-marker-alt" aria-hidden="true"></i>
   ' . $row['Location'] . '<br>';
          echo '<b><i class="far fa-tag" aria-hidden="true"></i></b> ' . $row['category'] . '<br><br>';
          echo '' . $row['Blog'] . '<br><br>';
          echo '<i class="far fa-heart"></i> ' . $row['likes'];
