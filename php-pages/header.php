...
<html>
  <head>
    ...
    <script src="https://ajax.googleapis.com/ajax/libs/jquery/3.2.0/jquery.min.js"></script>
      ...
      <style>
        #resize #menu li a, .column h5, .column a:hover, .feedpost a:visited, .feedpost a, .feedpost i, ul li a:hover, footer a:hover, footer .active a{color:<?php echo $currentcolor; ?>}
        .feedPostTitle img:hover, .videofeedPostTitle img:hover{border-color:<?php echo $currentcolor; ?>}
        #toggle.on .span, .location, .openbtn, .topslide, .text-box h2 {background-color:<?php echo $currentcolor; ?>}
        ...
        .footer-list ul li.a.active{color:<?php echo $currentcolor; ?>}
  ...
  if(!isset($_SESSION['username']) || empty($_SESSION['username'])) { 
      echo '<li class="not-active"><a href="about.php"><i class="fad fa-info-circle" aria-hidden="true"></i><div class="tooltip">About</div></a></li><li class="not-active"><a href="login.php"><i class="fad fa-sign-in" aria-hidden="true"></i><div class="tooltip">Login</div></a></li>';
  }
  else {
      ...
      echo '<li class="active"><a href="message.php"><i class="fad fa-comments" aria-hidden="true"></i><div class="tooltip">Messages</div></a></li>';
      }
      else {
      echo '<li class="not-active"><a href="message.php"><i class="fad fa-comments" aria-hidden="true"></i><div class="tooltip">Messages</div></a></li>';
};
  }
  ?>
