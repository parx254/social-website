...
<html>
  <head>
    ...
    <script src="https://ajax.googleapis.com/ajax/libs/jquery/3.2.0/jquery.min.js"></script>
      ...
      <style>
        ...
        .footer-list ul li.a.active,.dropbtn{color:<?php echo $currentcolor; ?>}
  ...
  if(!isset($_SESSION['username']) || empty($_SESSION['username'])) { 
      echo '<li class="not-active"><li class="not-active"><a href="login.php"><i class="fad fa-sign-in" aria-hidden="true"></i><div class="tooltip">Login</div></a></li>';
  }
  else {
