    ...
    if ($result->num_rows > 0) {
      while ($row = $result->fetch_assoc()) {
        ...
        while ($row2 = $results->fetch_assoc()) {
          ...
          echo '<i class="far fa-map-marker-alt" aria-hidden="true"></i> ' . $row['Location'] . '<br><br>';
          echo ' ' . $row['Blog'] . '<br><br>';
    ...
    if ($result->num_rows > 0) {
      while ($row = $result->fetch_assoc()) {
        ...
        while ($row2 = $results->fetch_assoc()) {
          ...
          echo "<b><a href='profile.php?currentuser=$username'>   " . $username . '</a></b></div>';
          echo '<p><i class="fa fa-calendar-o" aria-hidden="true"></i> ' . $date_posted . '<br>';
          echo '<i class="far fa-tag" aria-hidden="true"></i> ' . $row['videocategory'] . '<br>';
          echo '<i class="far fa-map-marker-alt" aria-hidden="true"></i> ' . $row['videolocation'] . '<br><br>';
          echo ' ' . $row['Blog'] . '<br><br>';
          echo '<i class="fa fa-heart-o"></i> ' . $row['likes'] . ' </div></div>';
        }
      }
    ...
    if ($result->num_rows > 0) {
      while ($row = $result->fetch_assoc()) {
        ...
        while ($row2 = $results->fetch_assoc()) {
          ...
          echo "<b><a href='profile.php?currentuser=$username'>   " . $username . '</a></b></div>';
          echo '<p><i class="fa fa-calendar-o" aria-hidden="true"></i> ' . $date_posted . '<br>';
          echo '<i class="far fa-tag" aria-hidden="true"></i> ' . $row['category'] . '<br>';
          echo '<i class="far fa-map-marker-alt" aria-hidden="true"></i> ' . $row['Location'] . '<br><br>';
          echo ' ' . $row['Blog'] . '<br><br>';
          echo '<i class="fa fa-heart-o"></i> ' . $row['likes'] . ' </div></div>';
        }
